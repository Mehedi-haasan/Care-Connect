    ...
    <div className='w-full bg-white p-3 shadow-md top-0 sticky z-50'>
      <div className="">
        <ul className='flex justify-between items-center gap-6 '>
          ...
          <li><a href="#" className="text-[#006aff]">স্বাস্থ্য | তথ্য | সহায়ক | সেবা</a></li>
          ...
          <li>
            <div className="flex justify-end items-center gap-1">
              <div className="relative">
                <svg xmlns="http://www.w3.org/2000/svg"  className={`absolute top-2.5 transition-all duration-500 ease-in-out ${focus ? 'right-1':'left-3'} text-[#A2775A]`} width="24" height="24" viewBox="0 0 24 24">
                ...
                <input onClick={()=>setFocus(!focus)} className="border rounded-l-3xl rounded-r-lg bg-[#F4E9DC] py-2 pl-4 focus:outline-none" />
              </div>
              <button className="py-2 px-2 border rounded-r-3xl rounded-l-lg bg-black text-white font-thin" >Search</button>
            </div>
          </li>
        </ul>
      </div>
