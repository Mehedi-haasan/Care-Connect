...
const CreateBrand = () => {
    ...
    const handleUpdate = async (image_url) => {
        ...
        try {
            const response = await fetch(`${BaseUrl}/api/create/content/type`, {
                method: 'POST',
                headers: {
                    'authorization': token,
        ...
        <div className="px-2 pt-5 min-h-screen pb-12">
            ...
            <div className="pt-1 bg-[#FFFFFF] shadow-lg rounded-lg w-full">
                <div className="border-b">
                    <h1 className="pl-5 text-xl py-2">Content Type Details</h1>
                </div>
                <div className="flex justify-start items-center gap-5 px-6 pt-5">
                    <div>
                        <p className='pb-2 font-thin'>Content  Picture</p>
