...
const WholeSell = ({ shop = [], editio = [], brand = [], category = [], state = [], info = {}, changeLan }) => {
    ...
    const fetchAmount = async () => {
        ...
        document.title = "Sale - Care-Connect";
    };
                        ...
                        <div className='flex justify-center w-full h-[39px] relative'>
                            ...
                            {searchData && searchData?.length > 0 && <div className='w-full absolute top-[36px] border bg-[#FFFFFF] shadow rounded-b'>
                                <div className="w-full text-sm text-left rtl:text-right text-gray-500">
                                    ...
                                    <div className='max-h-[350px] overflow-hidden overflow-y-scroll text-[12px]'>
                                ...
                                <div className={`border-b border-x text-[15px] text-black grid grid-cols-12`}>
                                    ...
                                    <div className="grid col-span-4">
                                        <div className="grid grid-cols-5 text-center">
                                            ...
                                            <div className="pl-2 py-2 text-center font-thin border-l">{DiscountCalculate(prepareData)}</div>
                                        </div>
                                    </div>
                                </div>
                            )}
                    ...
                    <div className='flex justify-between gap-5'>
                        <div>
                            <div className='flex justify-between'>
                                ...
                                <InputComponent placeholder={(values?.pay - lastTotal) * -1} value={(values?.pay - lastTotal) * -1} label={'Return Balance'} readOnly={true} className={``} />
                            </div>
