    ...
    return (
        <div className='w-full dark:bg-[#040404] dark:text-white' ref={cal}>
            ...
            <div className='flex justify-start items-center relative w-full'>
                <div onClick={() => { setIsFocus(!isFocus) }} className='border-y border-l border-blue-500 px-3 pt-[6px] pb-[6px] rounded-l cursor-pointer text-green-500 '>
                ...
                <div className='w-full'>
                    <input readOnly={readOnly} onClick={() => setIsFocus(false)} className='focus:outline-none dark:bg-[#040404] dark:text-white border border-transparent rounded [border-image:linear-gradient(to_right,#3b82f6,#ef4444)_1] pt-[7px] pb-[6px] px-1.5 rounded-r w-full font-thin text-[15px]' value={value} onChange={(e) => { }} placeholder={value} />
