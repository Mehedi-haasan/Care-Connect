                ...
                <div className="flex justify-end items-center gap-3">
                    {
                        auth && <div className="hidden md:block">
                            <NavLink to={`/create`} className="border font-thin hover:bg-blue-500 hover:text-white rounded-full px-5 py-1 text-md border-[#3A95EE] flex float-start items-center gap-1 text-[#3A95EE]"><Add />Content</NavLink>
                        </div>
                    }
