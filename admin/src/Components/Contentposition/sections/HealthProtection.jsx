import {
  ...
  const Health_Protection = () => {
    ...
    const fetchContents = async () => {
      try {
        ...
        const homeItems = (data.items || [])
          .filter((i) => i.section_name === "health_protection")
    ...
    const startEdit = (item) => {
      ...
      setEditSection(item.section_name || "health_protection");
    };
    ...
    return (
      <div className="max-w-5xl mx-auto p-6">
        <h1 className="text-1xl font-bold mb-6">
          স্বাস্থ্য সুরক্ষা অবস্থান পরিবর্তন
        </h1>
  ...
  export default Health_Protection;
